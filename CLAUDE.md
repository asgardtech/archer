...
**YOU ARE IN: `ready_archer_issue_801/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ready_archer_issue_801/` (rig root) or other directories
...
**Your mail address:** `ready_archer_issue_801/polecats/obsidian`
**Your rig:** ready_archer_issue_801
**Your Witness:** `ready_archer_issue_801/witness`
...
| Ask Witness for help | `gt mail send ready_archer_issue_801/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ready_archer_issue_801/witness`) when:
...
```bash
gt mail send ready_archer_issue_801/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
