...
export const ASSET_MANIFEST: AssetManifest = {
  ...
  enemy_boss_gunship: `${BASE}enemy_boss_gunship.svg`,
  enemy_boss_dreadnought: `${BASE}enemy_boss_dreadnought.svg`,
  enemy_boss_fortress: `${BASE}enemy_boss_fortress.svg`,
  enemy_boss_carrier: `${BASE}enemy_boss_carrier.svg`,
  ...
  powerup_battery:  `${BASE}powerup_battery.svg`,
  powerup_deflector: `${BASE}powerup_deflector.svg`,
  powerup_repair:   `${BASE}powerup_repair.svg`,
