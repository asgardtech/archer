...
export const ENEMY_PROJECTILE_SKINS: Partial<Record<EnemyVariant, ProjectileSkin>> = {
  ...
  // Act 2 — Dominion light/medium units: use colored sprite variants
  wasp:             { spriteKey: "bullet_enemy_green",  fallbackColor: "#ccff44", coreColor: "#eeff88", glowColor: "#ddff66" },
  phantom:          { spriteKey: "bullet_enemy_purple", fallbackColor: "#9966ff", coreColor: "#ccaaff", glowColor: "#bb88ff" },
  locust:           { spriteKey: "bullet_enemy_green",  fallbackColor: "#aaaa44", coreColor: "#cccc88", glowColor: "#bbbb66" },
  glider:           { spriteKey: "bullet_enemy_blue",   fallbackColor: "#88aacc", coreColor: "#bbccee", glowColor: "#99bbdd" },
  ...
  boss_swarm_queen: { spriteKey: "bullet_enemy_green",    fallbackColor: "#447733", coreColor: "#77aa66", glowColor: "#558844" },
  // Act 2 — Dominion special roles
  splitter:    { spriteKey: "bullet_enemy_green",  fallbackColor: "#44ddbb", coreColor: "#88ffdd", glowColor: "#66eecc" },
  healer:      { spriteKey: "bullet_enemy_green",  fallbackColor: "#66dd88", coreColor: "#aaffcc", glowColor: "#88eebb" },
  teleporter:  { spriteKey: "bullet_enemy_purple", fallbackColor: "#cc66ff", coreColor: "#ee99ff", glowColor: "#dd88ff" },
  mimic:       { spriteKey: "bullet_enemy_blue",   fallbackColor: "#bbbbdd", coreColor: "#ddddef", glowColor: "#ccccee" },
  jammer:      { spriteKey: "bullet_enemy_orange", fallbackColor: "#888866", coreColor: "#aaaa88", glowColor: "#999977" },
};
